...
echo -e "\nYou can now use this template to create new VMs using Terraform with this module."
echo -e "Make sure to set ${YELLOW}vm_template = \"$VM_NAME\"${NC} in your terraform.tfvars configuration.\n"
